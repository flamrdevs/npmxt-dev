import { Properties as CSSTypeProperties } from "csstype";
...
export namespace Props {
  export type Default<P extends Props = Props> = P & { style?: CSS.Properties; children?: Children };
  export type Root<P extends Props = Props> = P & { style: CSS.Properties.Root; children: Children };
  export type WithDefault<P extends Props = {}> = P & { style?: CSS.Properties; children?: Children };
  export type WithRoot<P extends Props = {}> = P & { style?: CSS.Properties.Root; children?: Children };
  export type WithDefaultStyle<P extends Props = {}> = P & { style?: CSS.Properties };
  export type WithRootStyle<P extends Props = {}> = P & { style?: CSS.Properties.Root };
